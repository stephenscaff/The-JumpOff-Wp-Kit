...
(function () {
    if (!window.Prism || !document.querySelector) return;
    var e = {
        js: "javascript",
        html: "markup",
        svg: "markup"
    ...
    Array.prototype.slice.call(document.querySelectorAll("pre[data-src]")).forEach(function (t) {
        ...
        o.onreadystatechange = function () {
            console.log(o.readyState, o.status, n);
            if (o.readyState == 4)
                if (o.status < 400 && o.responseText) {
                    s.textContent = o.responseText;
                    Prism.highlightElement(s)
                } else o.status >= 400 ? s.textContent = "âœ– Error " + o.status + " while fetching file: " + o.statusText : s.textContent = "âœ– Error: File does not exist or is empty"
        };
        o.send(null)
    })
})();
