...
function jumpoff_ft_img_help( $content ) {
  global $post_type;
  if( 'work' == $post_type ) :
    return $content .= '<p>Masthead Images: Size to 2000x1250px.</p>';
  elseif( 'posttypename' == $post_type ) :
    return $content .= '<p> Size to about 700x1050px.</p>';
  else :
    return $content .= '<p>Featured images appear in the Masthead and blog index previews. Size to 2000x1250px.</p>';
  endif;
}
